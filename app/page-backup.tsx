...
// import { createInitialSuperAdmin } from "@/lib/auth"; // Removido para evitar errores de IndexedDB
...
export default function Page() {
  ...
  // Inicializar SuperAdmin si no existe (removido para evitar errores de IndexedDB)
  // useEffect(() => {
